  ...
  return (
    <section className="my-20 relative">
      <div className="container z-10 mx-auto px-4">
        ...
        <div className="flex justify-center gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-none md:max-h-[740px] overflow-visible md:overflow-hidden">
