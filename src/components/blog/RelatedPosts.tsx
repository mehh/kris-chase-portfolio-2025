...
import { findRelatedPosts } from '@/lib/blog-ai-utils';
...
export function RelatedPosts({ currentPost }: RelatedPostsProps) {
  ...
  return (
    <section className="mt-16 pt-12 border-t-2 border-border/50">
      <div className="mb-8">
            ...
            >
              <article className="h-full rounded-xl border-2 border-border/50 bg-card/30 hover:border-primary/50 hover:bg-card/50 transition-all duration-300 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {/* Title */}
                  <h3 className="font-heading font-bold text-xl mb-2 text-foreground group-hover:text-primary transition-colors line-clamp-2">
                    {post.title}
                  </h3>
